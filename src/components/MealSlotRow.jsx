  ...
  return (
    <div className="flex items-start gap-2 px-2 py-1.5 rounded group">
      ...
      <div className="flex-1 min-w-0 relative">
        <input className="w-full border border-gray-300 rounded px-2 py-1 text-sm focus:outline-none focus:border-green-500"
          placeholder="Posiłek..."
          value={slot.name}
      ...
      <input className="flex-1 border border-gray-300 rounded px-2 py-1 text-sm focus:outline-none focus:border-green-500"
        placeholder="Składniki (po przecinku)..."
        value={slot.ingredients || ''}
        onChange={e => onChange({ ...slot, ingredients: e.target.value })} />
